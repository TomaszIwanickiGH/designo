...
const Card = ({ image, title, text }) => (
  <div className="flex xl:flex-col md:flex-row flex-col xl:w-[350px] xl:h-[478px] md:w-[689px] md:h-[310px] w-[327px] h-[478px]">
    ...
    />
    <div className="bg-veryLightPeach hover:bg-peach text-peach hover:text-white hover:cursor-pointer flex flex-col items-center justify-center gap-4 xl:rounded-es-lg xl:rounded-ee-lg xl:rounded-se-none md:rounded-se-lg md:rounded-es-none rounded-es-lg rounded-ee-lg p-6" id="hover">
