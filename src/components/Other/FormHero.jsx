...
const FormHero = () => {
  return (
    <section className={`${styles.paddingSmall} flex xl:flex-row flex-col-reverse rounded-lg`}>
      <div className={`${styles.padding} flex flex-col justify-center xl:gap-8 gap-4 bg-peach xl:rounded-ss-2xl xl:rounded-ee-none md:rounded-es-2xl md:rounded-ee-2xl bg-no-repeat`} style={{ backgroundImage: `url(${images.bgPatternHeroDesktop})` }}>
