...
const FormHero = () => {
  return (
    <section
      ...
      className={`${styles.paddingSmall} flex xl:flex-row flex-col rounded-lg`}
    >
      <div
        className={`${styles.padding} flex flex-col justify-center xl:gap-8 gap-4 bg-peach xl:rounded-ss-2xl xl:rounded-es-2xl xl:rounded-se-none md:rounded-ss-2xl md:rounded-se-2xl bg-no-repeat`}
        style={{ backgroundImage: `url(${images.bgPatternHeroDesktop})` }}
      >
