...
const HeroAbout = () => {
  return (
    <section
      ...
      className={`${styles.paddingSmall} flex xl:flex-row flex-col-reverse rounded-lg`}
    >
      <div
        className={`${styles.padding} flex flex-col justify-center xl:gap-8 gap-4 bg-peach xl:rounded-ss-2xl xl:rounded-ee-none md:rounded-es-2xl md:rounded-ee-2xl`}
        style={{ backgroundImage: `url(${images.bgHeroAboutDesktop})` }}
      >
      ...
      <img
        src={images.imageHeroAboutDesktop}
        alt="about-hero"
        className="rounded-se-2xl rounded-ee-2xl xl:flex hidden"
      />
      <img
        src={images.imageHeroAboutTablet}
        alt="about-hero"
        className="rounded-ss-2xl rounded-se-2xl xl:hidden md:flex hidden"
      />
      <img
        src={images.imageHeroAboutMobile}
        alt="about-hero"
